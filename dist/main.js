...
function mergeThemePart(base, override) {
    return { ...base, ...(override || {}) };
}
function getButtonGradient(style, colors, seed) {
    switch (style) {
        case 'retro-3d':
...
function getTexture(seed, colors) {
    switch (seed.texture) {
        case 'aero':
            return [
...
function getThemeBlueprint(seed) {
    const retroChrome = {
        colors: {
            bgPrimary: '#008080',
            bgSecondary: '#c0c0c0',
...
function createUITheme(seed) {
    ...
    const typography = mergeThemePart({
...
const UI_THEME_SEEDS = [
    ...
    { id: 'macos-aqua-blue', name: 'macOS Aqua Classic', category: 'Apple/iOS/macOS', hue: 202, accentHue: 198, surface: 'light', buttonStyle: 'bubble-aqua', radius: 16, intensity: 0.82, transitionSpeed: '0.22s', fontFamily: FONT_SYSTEM, texture: 'aero', shadowStyle: 'soft', tags: ['aqua', 'gel', 'blue'] },
    ...
    { id: 'ios-glass-aero', name: 'iOS Glass Aero', category: 'Apple/iOS/macOS', hue: 205, accentHue: 300, surface: 'light', buttonStyle: 'glass', radius: 24, intensity: 0.86, transitionSpeed: '0.28s', fontFamily: FONT_SYSTEM, texture: 'aero', tags: ['ios', 'glass', 'aero'] },
    ...
    { id: 'windows-xp-luna', name: 'Windows XP Luna Blue', category: 'Windows', hue: 214, accentHue: 112, surface: 'light', buttonStyle: 'glossy-luna', radius: 8, intensity: 0.78, transitionSpeed: '0.16s', fontFamily: FONT_SYSTEM, texture: 'plain', tags: ['xp', 'luna'] },
    ...
    { id: 'windows-7-aero', name: 'Windows 7 Aero Sky', category: 'Windows', hue: 204, accentHue: 189, surface: 'dark', buttonStyle: 'glass', radius: 12, intensity: 0.86, transitionSpeed: '0.22s', fontFamily: FONT_SYSTEM, texture: 'aero', tags: ['windows 7', 'aero'] },
    ...
    { id: 'one-ui-blue', name: 'One UI Blue', category: 'Android', hue: 218, accentHue: 202, surface: 'light', buttonStyle: 'soft-modern', radius: 26, intensity: 0.56, transitionSpeed: '0.24s', fontFamily: FONT_SYSTEM, texture: 'plain', tags: ['one ui'] },
    ...
    // Linux (20)
    { id: 'ubuntu-orange', name: 'Ubuntu Ambiance', category: 'Linux', hue: 20, accentHue: 20, surface: 'dark', buttonStyle: 'solid', radius: 8, intensity: 0.86, transitionSpeed: '0.16s', fontFamily: FONT_UBUNTU, texture: 'plain', tags: ['ubuntu'] },
    ...
    { id: 'kde-breeze-dark', name: 'KDE Breeze Dark', category: 'Linux', hue: 214, accentHue: 204, surface: 'dark', buttonStyle: 'glass', radius: 8, intensity: 0.66, transitionSpeed: '0.2s', fontFamily: FONT_SYSTEM, texture: 'glass', tags: ['kde', 'breeze'] },
...
function setThemeVariable(style, name, value) {
...
function renderThemeSelector(player) {
...
function rerenderProfileThemeSelector(container, focusSearch = false) {
...
function attachThemeSelectorEvents(container, player) {
    const searchInput = container.querySelector('#theme-search');
    searchInput?.addEventListener('input', (event) => {
        profileThemeQuery = event.target.value;
        rerenderProfileThemeSelector(container, true);
    });
    container.querySelectorAll('[data-theme-filter]').forEach(button => {
        button.addEventListener('click', () => {
            profileThemeCategory = button.dataset.themeFilter;
    ...
    container.querySelectorAll('[data-theme-activate]').forEach(button => {
        button.addEventListener('click', () => {
    ...
    container.querySelector('#theme-reset-preview')?.addEventListener('click', () => {
